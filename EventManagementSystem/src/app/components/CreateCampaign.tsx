...
export default function CreateCampaign() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Generate a mock campaign ID and create campaign data
    ...
    // Save campaign data to localStorage for demo purposes
    ...
    <DashboardLayout title="Create New Campaign">
      ...
      <div className="max-w-4xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          <h1 className="text-3xl mb-2" style={{ color: '#273480' }}>Create New Campaign</h1>
          <p className="text-gray-600 mb-8">Create a new marketing campaign for your events</p>
