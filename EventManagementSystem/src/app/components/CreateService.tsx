...
export default function CreateService() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Generate a mock service ID and create service data
    ...
    // Save service data to localStorage for demo purposes
    const existingServices = JSON.parse(localStorage.getItem('services') || '[]');
    localStorage.setItem('services', JSON.stringify([...existingServices, serviceData]));
  ...
  return (
    <DashboardLayout title="Create New Service">
      {/* Success Message */}
      {showSuccess && (
      ...
      <div className="max-w-4xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          <h1 className="text-3xl mb-2" style={{ color: '#273480' }}>Create New Service</h1>
          <p className="text-gray-600 mb-8">Create a new service package for your events</p>
